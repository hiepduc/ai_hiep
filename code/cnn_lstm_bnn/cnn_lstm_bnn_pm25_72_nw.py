...
joblib.dump(scaler, "pm25_bnn_nw_scaler_72.save")
joblib.dump(df.columns.tolist(), "pm25_bnn_nw_columns_72.save")
...
model = Sequential([
    ...
    # Replace Dense with Bayesian Dense
    TimeDistributed(
        tfp.layers.DenseVariational(units=n_features,
...
# model.save("cnn_lstm_bnn_model_pm25_nw_72input.h5")  # This is only applied to Keras not tfp layer
