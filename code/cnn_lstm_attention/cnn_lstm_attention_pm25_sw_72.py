...
N_SUBSEQ = 6     # 72 = 6subsequences of 12 hours each
EPOCHS = 30
BATCH_SIZE = 64
...
joblib.dump(scaler, "pm25_cnn_lstm_attention_sw_scaler_72.save")
joblib.dump(df.columns.tolist(), "pm25_cnn_lstm_attention_sw_columns_72.save")
...
model.save("cnn_lstm_attention_model_pm25_sw_72input.h5")
