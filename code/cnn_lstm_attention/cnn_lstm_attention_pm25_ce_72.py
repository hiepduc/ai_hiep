...
joblib.dump(scaler, "pm25_cnn_lstm_attention_ce_scaler_72.save")
joblib.dump(df.columns.tolist(), "pm25_cnn_lstm_attention_ce_columns_72.save")
...
model.save("cnn_lstm_attention_model_pm25_ce_72input.h5")
