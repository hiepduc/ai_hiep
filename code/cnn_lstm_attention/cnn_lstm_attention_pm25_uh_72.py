...
N_SUBSEQ = 6     # 72 = 8 subsequences of 12 hours each
EPOCHS = 30
BATCH_SIZE = 64
...
joblib.dump(scaler, "pm25_cnn_lstm_attention_uh_scaler_72.save")
joblib.dump(df.columns.tolist(), "pm25_cnn_lstm_attention_uh_columns_72.save")
...
model.save("cnn_lstm_attention_model_pm25_uh_72input.h5")
