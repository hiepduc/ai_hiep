...
joblib.dump(scaler, "pm25_cnn_lstm_attention_ce_scaler_120.save")
joblib.dump(df.columns.tolist(), "pm25_cnn_lstm_attention_ce_columns_120.save")
...
model.save("cnn_lstm_attention_model_pm25_ce_120input.h5")
