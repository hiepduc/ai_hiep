...
joblib.dump(scaler, "pm25_nw_scaler_120_vmd.save")
joblib.dump(df_vmd.columns.tolist(), "pm25_nw_columns_120_vmd.save")
...
# === 11. Save model ===
model.save("cnn_lstm_pm25_120_nw_vmd_model.h5")
...
metrics_df.to_csv("cnn_lstm_vmd_site_metrics.csv", index=False)
print("\nPer-site MAE/RMSE saved to: cnn_lstm_vmd_site_metrics.csv")
...
output_df.to_csv("cnn_lstm_vmd_predictions_120.csv", index=False)
print("Predictions saved to: cnn_lstm_vmd_predictions_120.csv")
