...
joblib.dump(scaler, "pm25_vmd_sw_scaler_120.save")
joblib.dump(df_vmd.columns.tolist(), "pm25_vmd_sw_columns_120.save")
...
# === 11. Save model ===
model.save("cnn_lstm_vmd_model_pm25_sw_120input.h5")
...
metrics_df.to_csv("cnn_lstm_vmd_sw_site_metrics.csv", index=False)
print("\nPer-site MAE/RMSE saved to: cnn_lstm_vmd_sw_site_metrics_120.csv")
...
output_df.to_csv("cnn_lstm_vmd_sw_predictions_120.csv", index=False)
print("Predictions saved to: cnn_lstm_vmd_sw_predictions_120.csv")
