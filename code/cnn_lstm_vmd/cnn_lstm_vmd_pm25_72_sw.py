...
joblib.dump(scaler, "pm25_vmd_sw_scaler_72.save")
joblib.dump(df_vmd.columns.tolist(), "pm25_vmd_sw_columns_72.save")
...
plt.tight_layout()
plt.savefig("cnn_lstm_vmd_all_sites_sw_prediction_72.png")
plt.show()

# === 11. Save model ===
model.save("cnn_lstm_vmd_model_pm25_sw_72input.h5")
...
metrics_df.to_csv("cnn_lstm_vmd_site_metrics_72.csv", index=False)
print("\nPer-site MAE/RMSE saved to: cnn_lstm_vmd_site_metrics_72.csv")
