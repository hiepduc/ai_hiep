...
joblib.dump(scaler, "pm25_uh_scaler.save")
joblib.dump(df.columns.tolist(), "pm25_uh_columns.save")
...
history = model.fit(X_train, y_train,
                    ...
                    verbose=2)
model.save("cnn_lstm_model_pm25_uh_72input.h5")
...
summary_df.to_csv("test_summary_metrics_uh.csv", index=False)
...
pd.DataFrame(site_mae_list).to_csv("test_site_mae_uh.csv", index=False)
...
df_combined.to_csv("test_predictions_vs_actual_uh.csv")
...
fig.write_html("test_forecast_dashboard_uh.html")
print("✅ Interactive dashboard saved to test_forecast_dashboard_uh.html")
