...
joblib.dump(scaler, "pm25_illawarra_scaler_72.save")
joblib.dump(df.columns.tolist(), "pm25_illawarra_columns_72.save")  # Save feature order
...
model.save("cnn_lstm_model_pm25_illawarra_72input.h5")
...
sites_to_plot = ['PM2.5_ALBION_PARK_SOUTH', 'PM2.5_KEMBLA_GRANGE', 'PM2.5_WOLLONGONG']
