...
N_INPUT = 120     # Use 120 hours as input
N_OUTPUT = 6      # Forecast 6 hours ahead
N_SUBSEQ = 10     # 120 / 10 = 12 time steps per subsequence
EPOCHS = 30
BATCH_SIZE = 64
...
joblib.dump(scaler, "pm25_ce_scaler_120.save")
n_features = scaled_data.shape[1]
# Save the column order
joblib.dump(df.columns.tolist(), "pm25_ce_columns_120.save")
...
model.save("cnn_lstm_model_pm25_ce_120input.h5")
